                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fname" name="first-name" value="{{ old('first-name') }}">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lname" name="last-name" value="{{ old('last-name') }}">
                                    </div>
                                    @error('last-name')
                                        <div style="color: red ; font-size: 10px;">{{ $message }}</div>
                                    @enderror
